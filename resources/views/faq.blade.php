    ...
    <div class="text-center">
        ...
        <div class="mt-8">
            ...
            <p class="mt-4">Pour modifier le numéro de SIRET de votre entreprise sur le site, vous devez contacter Parsewaves<br> 
                en cliquant sur le bouton <span class=""font-semibold>Contacter Parsewaves</span> situé en bas à droite de l'écran.
                [...]
            </p>

            <h2 class="font-semibold mt-12 text-lg">Exemple de question n°1</h2>
            <p class="mt-4">Exemple de réponse n°1
            </p>
        </div>
        <div class="mt-8">
            ...
            <p class="mt-4">Pour modifier votre profil utilisateur, <span class="font-semibold">dirigez-vous en haut à droite de votre écran </span>, puis cliquez sur <span class="font-semibold">Accéder à mon profil"</span>.<br>
                Ensuite, Cliquez sur <span class="font-semibold">"Modifier mon profil"</span> en-dessous de votre icône utilisateur. Une fois vos modifications faites, <br><span class="font-semibold">n'oubliez pas de les 
                sauvegarder</span> en cliquant sur le bouton "Sauvegarder" situé en bas de la page</span>.
            </p>

            <h2 class="font-semibold mt-12 text-lg">Exemple de question n°2</h2>
            <p class="mt-4">Exemple de réponse n°2
            </p>

            <h2 class="font-semibold mt-12 text-lg">Exemple de question n°3</h2>
            <p class="mt-4">Exemple de réponse n°3
            </p>
        </div>
